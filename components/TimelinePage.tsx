        ...
        <div className="flex-shrink-0 bg-white border-b border-gray-200 px-6 py-4 flex flex-col md:flex-row justify-between items-center gap-4 z-20 sticky top-0">
            <div className="flex items-center gap-4">
                <div className="flex items-center gap-2 bg-gray-50 p-1 rounded-lg border border-gray-200 relative">
                    <button className="p-1.5 hover:bg-white rounded-md shadow-sm transition-all z-10"><ChevronLeft size={16} className="text-gray-500" /></button>
                    ...
                    <button className="p-1.5 hover:bg-white rounded-md shadow-sm transition-all z-10"><ChevronRight size={16} className="text-gray-500" /></button>
                </div>

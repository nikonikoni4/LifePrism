...
const AIChatPanel: React.FC<AIChatPanelProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed right-0 top-0 h-full w-full sm:w-[400px] bg-white z-50 transform transition-transform duration-300 ease-in-out flex flex-col border-l border-gray-200 shadow-2xl lg:shadow-none ${isOpen ? 'translate-x-0' : 'translate-x-full'
          }`}
      >
        {/* Header */}

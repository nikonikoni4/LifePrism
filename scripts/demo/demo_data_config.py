...
GOAL_JOURNAL_TEMPLATES = [
    {"goal_id": "goal-daily", "content": "今天按计划推进了项目开发，完成了计划中的主要任务", "mood": "calm", "duration": 240},
    {"goal_id": "goal-daily", "content": "学习了新技术框架的基础概念，做了一些实践练习", "mood": "joy", "duration": 90},
    {"goal_id": "goal-daily", "content": "今天效率一般，只完成了部分计划任务，需要调整节奏", "mood": "pensive", "duration": 120},
    {"goal_id": "goal-example", "content": "完善了项目的文档结构，补充了关键模块的使用说明", "mood": "calm", "duration": 60},
    {"goal_id": "goal-example", "content": "进行了代码审查，发现并修复了 2 个潜在问题", "mood": "joy", "duration": 45},
]

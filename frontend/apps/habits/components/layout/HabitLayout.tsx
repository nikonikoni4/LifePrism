...
export const HabitLayout: React.FC<HabitLayoutProps> = ({ children }) => {
    return (
        <div className="h-screen w-full flex justify-center bg-[linear-gradient(180deg,#F8FAFC_0%,#F1F5F9_100%)] py-4 px-4 sm:px-6 lg:px-8 overflow-y-auto overflow-x-hidden">

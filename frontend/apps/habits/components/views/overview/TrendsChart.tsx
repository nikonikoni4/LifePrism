...
export const TrendsChart: React.FC = () => {
    ...
    return (
        <div className="flex flex-col justify-between bg-[linear-gradient(180deg,#FFFFFF_0%,#F3FBF8_100%)] rounded-[24px] p-5 shadow-[0_10px_28px_rgba(15,23,42,0.08)] border border-emerald-100/70 relative h-full">
            <div className="flex items-center justify-between mb-4">
                <h2 className="text-[14px] font-semibold text-slate-700 uppercase tracking-[0.02em]">4周趋势</h2>

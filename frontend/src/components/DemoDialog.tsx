        ...
        <div className="p-8">
          ...
          <div className="space-y-4 mb-6">
            ...
            <div className="p-4 bg-blue-50 rounded-lg">
              <h3 className="text-sm font-semibold text-blue-900 mb-2">🚀 开源项目</h3>
            ...
            <div className="p-4 bg-purple-50 rounded-lg">
              <h3 className="text-sm font-semibold text-purple-900 mb-2">🏆 参与投票</h3>
            ...
            <div className="p-4 bg-amber-50 rounded-lg">
              <h3 className="text-sm font-semibold text-amber-900 mb-2">⚠️ 只读演示</h3>
              <p className="text-sm text-amber-800 mb-2">
                为了防止恶意数据写入，当前 Demo 环境为<strong>只读模式</strong>，无法保存数据修改。
              </p>
              <p className="text-sm text-amber-800">
                如需完整体验，请到 GitHub 下载安装包本地安装，或克隆代码本地部署。
              </p>
            </div>
          </div>
          ...
          <button
            onClick={handleClose}
            className="w-full px-4 py-2 text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition-colors font-medium"
          >
            开始体验
          </button>
        </div>

...
class ActivitySummaryService:
    ...
    def get_activity_summary_data(self, date: str,history_days: int,future_days: int ):
        """获取活动总结数据"""
        # 计算开始时间和结束时间
        ...
        # 查询数据库中的实际数据
        daily_activities = self.statistical_data_provider.get_daily_active_time(start_date, end_date)

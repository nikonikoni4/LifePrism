...
from lifewatch.llm.langchain_test.state_define import classifyState, LogItem, AppInFo
from lifewatch.llm.langchain_test.mock_data import mock_goals
...
class DataLoader:
    ...
    def __init__(self, db_path: Optional[str] = None):
        ...
        """
        self.lw_db_manager = LifeWatchDataManager(db_path=db_path or config.DB_PATH)

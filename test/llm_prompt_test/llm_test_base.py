...
class LLMTestBase(ABC):
    ...
    def __init__(self,prompt:PromptRef,prompt_version:str,input_path:Path,output_path : Path = Path("D:/desktop/软件开发/LifeWatch-AI/test/llm_prompt_test.py"),temperature=0.7):
        """
        args : 
...
if __name__ == "__main__":
    t = LLMTestBase(Prompts.Schedule.CREATE_DIARY_SUMMARY,"v1",Path("D:/desktop/软件开发/LifeWatch-AI/test/llm_prompt_test.py/dataset"),Path("D:/desktop/软件开发/LifeWatch-AI/test/llm_prompt_test.py//"))

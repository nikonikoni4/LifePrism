...
def test_data():
    ...
    # 创建待办事项
    todo_data = {"content": "Test todo", "date": "2026-04-28", "state": "active", "order_index": 0}
...
def test_query_todolist(test_data):
    """测试查询待办事项"""
    result = query_data(
        query_option={"todolist"}, start_time="2026-04-28 00:00:00", end_time="2026-04-28 23:59:59"
    )
...
def test_invalid_time_format():
    ...
    with pytest.raises(ValueError, match="Invalid time format"):
        query_data(query_option={"goals"}, start_time="2026-04-28", end_time="2026-04-28 23:59:59")
...
def test_invalid_time_range():
    ...
    with pytest.raises(ValueError, match="start_time must be before end_time"):
        query_data(
            query_option={"goals"}, start_time="2026-04-28 23:59:59", end_time="2026-04-28 00:00:00"
        )

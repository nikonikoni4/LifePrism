...
class TestQuerySinglePurposeMapCache:
    ...
    def test_query_all(self):
        ...
        single_purpose_map_cache_provider.insert_single_purpose_map_cache(
    ...
    def test_query_with_filters(self):
        ...
        cache_id = generate_test_id()
        data = create_test_record(
            cache_id, app="unique_single_app.exe", title="Unique Single Title"
        )
...
class TestUpdateSinglePurposeMapCache:
    ...
    def test_update_success(self):
        ...
        result = single_purpose_map_cache_provider.update_single_purpose_map_cache(
...
class TestBatchOperations:
    ...
    def test_batch_update(self):
        ...
        # 批量更新
        update_data = {"state": 0}
        count = single_purpose_map_cache_provider.batch_update_single_purpose_map_cache(

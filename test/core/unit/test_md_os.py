...
_md_os = _load_md_os()
write_behavior_md = _md_os.write_behavior_md
extract_behavior_md = _md_os.extract_behavior_md
...
class TestWriteBehaviorMd:
    ...
    def test_write_behavior_md_create_new_file(self):
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            write_behavior_md(file_path=file_path, date=date, content=content, subheading="日记总结", mode="append")
    ...
    def test_write_behavior_md_overwrite_existing_date(self):
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            content = "全新的内容！"
            write_behavior_md(file_path=file_path, date=date, content=content, subheading="日记总结", mode="overwrite")
    ...
    def test_write_behavior_md_invalid_mode(self):
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with pytest.raises(ValueError) as excinfo:
                write_behavior_md(file_path=file_path, date="2026-04-16", content="test", subheading="日记总结", mode="unknown_mode")
    ...
    def test_write_behavior_md_insert_between_dates_in_order(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            write_behavior_md(file_path=file_path, date="2026-04-12", content="04-12 的内容", subheading="日记总结", mode="append")
    ...
    def test_write_behavior_md_insert_smallest_date_at_front(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            write_behavior_md(file_path=file_path, date="2026-04-01", content="04-01 的内容", subheading="日记总结", mode="append")
    ...
    def test_write_behavior_md_append_new_date_is_largest(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            write_behavior_md(file_path=file_path, date="2026-04-17", content="04-17 的内容", subheading="日记总结", mode="append")
...
class TestWriteBehaviorMdSubheading:
    """Tests for write_behavior_md requiring subheading parameter."""

    def test_write_behavior_md_requires_subheading(self):
        """write_behavior_md must raise ValueError when subheading is None."""
        with tempfile.TemporaryDirectory() as tmpdir:
            file_path = Path(tmpdir) / "behavior.md"
            with pytest.raises(ValueError):
                write_behavior_md(file_path, "2026-04-18", "content", subheading=None)

    def test_write_behavior_md_requires_subheading_empty_string(self):
        """write_behavior_md must raise ValueError when subheading is empty string."""
        with tempfile.TemporaryDirectory() as tmpdir:
            file_path = Path(tmpdir) / "behavior.md"
            with pytest.raises(ValueError):
                write_behavior_md(file_path, "2026-04-18", "content", subheading="")

    def test_write_behavior_md_with_subheading_creates_heading_structure(self):
        """write_behavior_md should create ## date -> ### subheading structure."""
        with tempfile.TemporaryDirectory() as tmpdir:
            file_path = Path(tmpdir) / "behavior.md"
            date = "2026-04-18"
            subheading = "日记总结"
            ...
            write_behavior_md(file_path, date, content, subheading=subheading)
...
class TestExtractBehaviorMdSubheading:
    """Tests for extract_behavior_md subheading filtering."""

    def test_extract_behavior_md_reads_named_subheading_only(self):
        """extract_behavior_md should only return content under the specified subheading."""
        markdown = """
## 2026-04-18
...
"""
    ...
    def test_extract_behavior_md_reads_all_subheadings_by_default(self):
        """extract_behavior_md with subheading='all' should return all subheading content."""
        markdown = """
## 2026-04-18
...
other body
"""
        result = extract_behavior_md(markdown, "2026-04-18", subheading="all")

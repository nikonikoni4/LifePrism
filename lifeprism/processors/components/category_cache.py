...
class CategoryCache:
    ...
    def __init__(self, cache_df: pd.DataFrame | None = None):
        """
        初始化缓存索引
        ...
        self._app_category_map: dict[str, tuple[str, str | None, str | None]] = {}
        self._title_category_map: dict[str, tuple[str, str | None, str | None]] = {}
    ...
    def _build_indexes(self, cache_df: pd.DataFrame) -> None:
        ...
        multi_with_category = multi_purpose_df[
            multi_purpose_df["category_id"].notna() & multi_purpose_df["title"].notna()
        ]
    ...
    def get_single_purpose_category(self, app: str) -> tuple[str, str | None, str | None] | None:
        """
        获取单用途应用的分类
    ...
    def get_multipurpose_category(
        self, app: str, title: str

...
from lifeprism.llm.llm_classify.schemas.data_driving_schemas import ExecutionPlan, NodeDefinition
from typing import Literal

def get_daily_summary_plan(date: str,json_path: Path, pattern_name= "complex") -> tuple[ExecutionPlan, dict[str, int] | None]:
    """
    获取每日总结的执行计划
...
def get_weekly_summary_plan(start_date: str, end_date: str) -> tuple[ExecutionPlan, dict[str, int] | None]:
    """
    获取周总结的执行计划

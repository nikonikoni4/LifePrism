...
def get_timeline_stats(
    ...
    """
    return build_timeline_stats(start_time, end_time, hour_granularity, category_level)


def get_timeline_time_overview(start_time: str, end_time: str) -> TimelineTimeOverviewResponse:
    """
    ...
    title = f"{local_start.strftime('%H:%M')} - {local_end.strftime('%H:%M')}"

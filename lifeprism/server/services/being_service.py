...
from lifeprism.server.providers.being_provider import being_provider
...
def get_test_result(user_id: int, mode: str, version: int = None) -> dict[str, Any] | None:
    """
    获取测试结果
...
def save_test_result(
    user_id: int, mode: str, content: dict[str, Any], version: int = None
) -> dict[str, Any] | None:
    """
    保存测试结果
...
def update_test_result(user_id: int, mode: str, version: int, content: dict[str, Any]) -> bool:
    """
    更新测试结果
    ...
    Returns:
        bool: 是否成功
    """
    return being_provider.update_by_user_mode_version(user_id, mode, version, {"content": content})


def upsert_test_result(
    user_id: int, mode: str, version: int, content: dict[str, Any], ai_abstract: str = None
) -> bool:
    """
...
def update_ai_abstract(user_id: int, mode: str, version: int, ai_abstract: str) -> bool:
    """
    更新 AI 总结
...
def generate_ai_abstract(user_id: int, mode: str, version: int) -> str | None:
    """

...
async def incremental_sync(sync_request: SyncRequest = SyncRequest()):
    """
    ...
    **注意**:
    ...
    result = await sync_service.incremental_sync(auto_classify=sync_request.auto_classify)
    return result


@router.post(
    "/activitywatch/timerange",
    response_model=SyncResponse,
    summary="按时间范围同步ActivityWatch数据",
)
async def incremental_sync_by_time_range(sync_request: SyncTimeRangeRequest):
    """

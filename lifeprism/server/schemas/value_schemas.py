...
class ValueItem(BaseModel):
    ...
    content_positive: str | None = Field(default=None, description="正向描述")
    content_negative: str | None = Field(default=None, description="负向描述")
...
class UpdateValueRequest(BaseModel):
    ...
    keywords: str | None = Field(default=None, description="关键词（支持多个，使用分号分隔）")
    content_positive: str | None = Field(default=None, description="正向描述")
    content_negative: str | None = Field(default=None, description="负向描述")

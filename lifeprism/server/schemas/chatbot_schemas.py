...
class UpdateModelConfigRequest(BaseModel):
    ...
    enable_search: bool | None = Field(default=None, description="启用搜索功能")
    enable_thinking: bool | None = Field(default=None, description="启用深度思考模式")
...
class ChatStreamEvent(BaseModel):
    ...
    node: str | None = Field(default=None, description="当前节点名称（status/content 事件）")
    message: str | None = Field(default=None, description="状态描述或内容片段")
    session_id: str | None = Field(default=None, description="会话 ID（session 事件）")
...
class ChatCompletionResponse(BaseModel):
    ...
    token_usage: TokenUsageEstimate | None = Field(default=None, description="Token 使用情况")
...
class ChatMessage(BaseModel):
    ...
    content: str = Field(..., description="消息内容")
    timestamp: str | None = Field(default=None, description="消息时间戳")
...
class ChatHistoryResponse(BaseModel):
    ...
    session_name: str = Field(..., description="会话名称")
    messages: list[ChatMessage] | None = Field(default=[], description="消息列表")

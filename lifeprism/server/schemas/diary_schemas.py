...
class DiaryItem(BaseModel):
    ...
    mood: str | None = Field(
        default=None, description="心情: very_happy, happy, calm, bad, very_bad"
    )
    importance: str | None = Field(
        default=None, description="平凡程度: important, normal, unimportant"
    )
    custom_tags: list[str] = Field(default=[], description="自定义 tag 列表")
    word_count: int = Field(default=0, description="字数统计")
    ai_summary: str | None = Field(default=None, description="AI 总结")
    diary_source_hash: str | None = Field(default=None, description="当前 AI 总结对应的正文 hash")
...
class DiaryMetaItem(BaseModel):
    ...
    importance: str | None = Field(default=None, description="平凡程度")
    custom_tags: list[str] = Field(default=[], description="自定义 tag 列表")
    word_count: int = Field(default=0, description="字数统计")
    ai_summary: str | None = Field(default=None, description="AI 总结")
    diary_source_hash: str | None = Field(default=None, description="当前 AI 总结对应的正文 hash")
...
class UpdateDiaryMetaRequest(BaseModel):
    ...
    custom_tags: list[str] | None = Field(default=None, description="自定义 tag 列表")

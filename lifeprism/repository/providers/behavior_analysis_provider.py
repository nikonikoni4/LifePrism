...
class BehaviorAnalysisProvider(LWBaseDataProvider):
    ...
    _FILTER_FIELDS: Set[str] = {
        'start_time', 'end_time', 'behavior', 'behavior_summary',
        'title', 'screen_count', 'created_at'
    }
    ...
    _UPDATE_FIELDS: Set[str] = {
        'end_time', 'behavior', 'behavior_summary', 'title', 'screen_count'
    }
    ...
    def get_behaviors_by_date_range(
        self,
        start_date: str,
        end_date: str
    ) -> List[Dict[str, Any]]:
    ...
    def delete_behaviors_by_date_range(
        self,
        start_date: str,
        end_date: str
    ) -> int:

...
const CategoryFilter: React.FC<CategoryFilterProps> = ({
    ...
    const defaultButtonClass = `flex items-center justify-center gap-2 px-4 py-2.5 border rounded-xl text-sm font-semibold hover:bg-gray-50 hover:border-gray-300 transition-all shadow-sm ${
        hasFilter
